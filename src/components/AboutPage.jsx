const aboutParagraphs = [
  ...
  'Often the handwritten varieties were illegible. Even more often, I would find what I clearly considered to be strikingly meaningful at the time and think, waa-how. What could I have possibly meant by that. :)',
  ...
  'or, vibrant, light, and soft to the touch, it’s clear they will pass with new data for the data bucket.',
...
export function AboutSection({ className = '' }) {
  ...
  return (
    <section className={sectionClassName} aria-label="About">
